...
<input style="text-align: center;" class="form-control" type="date" name="dob" id="dob" autocomplete="off" required>
...
<input class="form-control" type="text" name="adhaar" id="adhaar" maxlength="16" minlength="16" placeholder="*****************">
...
<input class="form-control" type="text" name="Pan" id="Pan" maxlength="10" minlength="10" placeholder="*****************">
...
<input class="form-control" type="tel" id="Mobile" name="Mobile" maxlength="13" minlength="10" autocomplete="off" required placeholder="9687459****">
...
<input class="form-control" type="text" id="Gaurantier_A/C" name="Gaurantier_A/C" autocomplete="off" required>
...
<input class="form-control" type="text"  name="AC_NUMBER" value="<?php $_SESSION['accounttt'] = rand(100000000 , 9999999999);
echo $_SESSION['accounttt'] . " ". " ". " " . " ". " ". "***this is not permanent account number" ?>" disabled>
<p style="color: red; float: left;"> ***NOTE THIS IS NOT YOUR PERMANENT ACCOUNT NUMBER***  </p> 
<br>
<br>
<label style="float: left;"> Account Holder name </label>
<input class="form-control" type="text" value=""  name="AC_HOLDER" id="A/C_HOLDER" autocomplete="off" required>
...
$CAC_NO = $_SESSION['accounttt'];

$time = $_SESSSION['date'];

$insert = " INSERT INTO `saving account`(`full name`, `date of birth`, `Gender`, `Email-Id`, `Adhaar no.`, `Pan card No.`, `Address`, `Mobile no.`, `your image`, `Gaurantier Name`, `Gaurantier Account number`, `Gaurantier Permanent Adress`, `Gaurantier Image`, `account numbrr`, `opening date & time`)
...
?>
<script> window.open("set.php")</script>
<?php
