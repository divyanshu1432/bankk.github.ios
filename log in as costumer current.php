...
<img style="transform: translate(110% , 30%); opacity: .1; position: fixed;" src="https://lofrev.net/wp-content/photos/2014/09/A-logo.png" width="400px" height="400px">
 <h3 style="text-align: center; margin-top: px; margin-top: 30px;"> (Costumer current Account Log In)</h3>
<div class="container">
...
<input type="submit" class="btn btn-lg btn-block" name="submit" style="background: #b83369; color: #fff;" value="PROCEED">
...
$q = "SELECT * FROM `password set current account`  WHERE `ACCOUNT nm` = '$costumer' && `password` = '$password'";
