...
<div class="col-xl-6 col-lg-6 col-md-12 col-12">
<input style="margin-left:0px;" type="text" name="pan" placeholder="PAN NUMBER" maxlength="14" minlength="8"  autocomplete="off" autofocus required>
...
$upsate = "UPDATE `current account` SET `Adhaar no.` = '$_POST[adhaar]' , `Pan card No.` = '$x' , `Mobile no.` = '$_POST[mob]' WHERE `Account number` = '$_POST[accountno]'";
...
<script> alert('wrong Account number') </script>
