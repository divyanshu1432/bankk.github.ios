...
<input class="form-control"  value="<?php  echo $_SESSION['accountt']; ?>" disabled>
...
$body = "you current account has been opened succesfully your ACCOUNT NO IS $x and your password is $y  keep connect with APNA BANK . ";
...
$insert = " INSERT INTO `password set current account`( `email`, `password`, `HASH PASSWORD`, `ACCOUNT nm`) VALUES ('$to','$y', '$var' ,'$x') ";
